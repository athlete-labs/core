...
import AthleteLabsCoreAthletelabsCoreCore from './athlete-labs/core/athletelabs.core.core'
...
export default { 
  AthleteLabsCoreAthletelabsCoreCore: load(AthleteLabsCoreAthletelabsCoreCore, 'athletelabs.core.core'),
